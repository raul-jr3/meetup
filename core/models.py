...
class Meetup(models.Model):
    ...
    attendees = models.ForeignKey(User, related_name = "attending", on_delete = models.CASCADE)
    not_sure = models.ForeignKey(User, related_name = "not_sure", on_delete = models.CASCADE)
